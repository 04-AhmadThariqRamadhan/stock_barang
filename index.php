...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Admin Barang</a>
            <!-- Sidebar Toggle-->
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        while($data=mysqli_fetch_array($ambilsemuadatastock)){
                                            ...
                                            $total_hargabarang = $data['total_hargabarang'];
                                            $idb = $data['idbarang'];
                                        ...
                                        <div class="modal fade" id="delete<?=$idb;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                    <div class="modal-body">
                                                        Apakah Anda yaakin ingin menghapus <?=$namabarang;?>?
                                                        <input type="hidden" name="idb" value="<?=$idb?>">
                                                    <br>
                                                    <br>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <br>
            <input type="number" name="idbarang" placeholder="Id Barang" class="form-control" required>
            <br>
            ...
            <br>
            <input type="number" name="hargabarang" placeholder="Harga Barang Satuan" class="form-control" required>
            <br>
